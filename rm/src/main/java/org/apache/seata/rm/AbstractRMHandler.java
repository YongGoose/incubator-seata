...
public abstract class AbstractRMHandler extends AbstractExceptionHandler
    ...
    public BranchRollbackResponse handle(BranchRollbackRequest request) {
        ...
        exceptionHandleTemplate(
                new AbstractCallback<BranchRollbackRequest, BranchRollbackResponse>() {
                    @Override
                    public void execute(
                            BranchRollbackRequest request, BranchRollbackResponse response)
                            throws TransactionException {
    ...
    public AbstractResultMessage onRequest(AbstractMessage request, RpcContext context) {
        ...
        AbstractTransactionRequestToRM transactionRequest =
                (AbstractTransactionRequestToRM) request;
    ...
    public void onResponse(AbstractResultMessage response, RpcContext context) {
        LOGGER.info(
                "the rm client received response msg [{}] from tc server.", response.toString());
    }
