...
public class AutoDataSourceProxyRegistrar implements ImportBeanDefinitionRegistrar {
     ...
     */
    public static final String BEAN_NAME_SEATA_AUTO_DATA_SOURCE_PROXY_CREATOR =
    ...
    public void registerBeanDefinitions(
        ...
        String dataSourceProxyMode =
                (String) annotationAttributes.get(ATTRIBUTE_KEY_DATA_SOURCE_PROXY_MODE);
        ...
        if (!registry.containsBeanDefinition(BEAN_NAME_SEATA_AUTO_DATA_SOURCE_PROXY_CREATOR)) {
            ...
            registry.registerBeanDefinition(
                    BEAN_NAME_SEATA_AUTO_DATA_SOURCE_PROXY_CREATOR, beanDefinition);
        }
    }
}
