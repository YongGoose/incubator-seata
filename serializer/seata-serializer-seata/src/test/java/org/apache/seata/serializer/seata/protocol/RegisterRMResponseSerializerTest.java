...
public class RegisterRMResponseSerializerTest {
    ...
    public void test_codec() {
        ...
        //        Assert.assertEquals(registerRMRespons2.getExtraData(),
        // registerRMResponse.getExtraData());
        //        Assert.assertEquals(registerRMRespons2.getMsg(), registerRMResponse.getMsg());
        //        Assert.assertEquals(registerRMRespons2.getByCode(),
        // registerRMResponse.getByCode());
    }
}
