...
public class RegisterTMResponseSerializerTest {
    ...
    public void test_codec() {
        ...
        //        Assert.assertEquals(registerTMResponse2.getExtraData(),
        // registerTMResponse.getExtraData());
        //        Assert.assertEquals(registerTMResponse2.getMsg(), registerTMResponse.getMsg());
        //        Assert.assertEquals(registerTMResponse2.getByCode(),
        // registerTMResponse.getByCode());
    }
}
