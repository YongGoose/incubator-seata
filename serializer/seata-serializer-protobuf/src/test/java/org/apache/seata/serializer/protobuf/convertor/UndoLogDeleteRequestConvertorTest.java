...
public class UndoLogDeleteRequestConvertorTest {
    ...
    public void convert2Proto() {
        ...
        UndoLogDeleteRequestConvertor undoLogDeleteRequestConvertor =
                new UndoLogDeleteRequestConvertor();
        UndoLogDeleteRequestProto proto =
                undoLogDeleteRequestConvertor.convert2Proto(undoLogDeleteRequest);
