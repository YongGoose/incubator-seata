...
public class MergeMessageConvertorTest {
    ...
    public void test() {
        ...
        MergedWarpMessageProto globalBeginRequestProto =
                pbConvertor.convert2Proto(mergedWarpMessage);
        ...
        assertThat(decodeModel.getTransactionName())
                .isEqualTo(globalBeginRequest.getTransactionName());
