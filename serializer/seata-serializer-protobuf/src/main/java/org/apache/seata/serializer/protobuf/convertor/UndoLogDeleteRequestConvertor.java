...
public class UndoLogDeleteRequestConvertor
        implements PbConvertor<UndoLogDeleteRequest, UndoLogDeleteRequestProto> {
    @Override
    public UndoLogDeleteRequestProto convert2Proto(UndoLogDeleteRequest undoLogDeleteRequest) {
        ...
        final UndoLogDeleteRequestProto undoLogDeleteRequestProto =
                UndoLogDeleteRequestProto.newBuilder()
