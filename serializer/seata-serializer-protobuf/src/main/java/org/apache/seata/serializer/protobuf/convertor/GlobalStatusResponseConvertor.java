...
public class GlobalStatusResponseConvertor
        implements PbConvertor<GlobalStatusResponse, GlobalStatusResponseProto> {
    @Override
    public GlobalStatusResponseProto convert2Proto(GlobalStatusResponse globalStatusResponse) {
                ...
                AbstractTransactionResponseProto.newBuilder()
                        ...
                        .setTransactionExceptionCode(
                                TransactionExceptionCodeProto.valueOf(
                                        globalStatusResponse.getTransactionExceptionCode().name()))
                        .build();
        ...
        GlobalStatusResponseProto result =
                GlobalStatusResponseProto.newBuilder()
