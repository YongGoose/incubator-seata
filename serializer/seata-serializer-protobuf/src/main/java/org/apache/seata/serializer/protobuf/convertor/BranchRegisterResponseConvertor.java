...
public class BranchRegisterResponseConvertor
    ...
    @Override
    public BranchRegisterResponseProto convert2Proto(
        ...
        BranchRegisterResponseProto result =
                BranchRegisterResponseProto.newBuilder()
    ...
    @Override
    public BranchRegisterResponse convert2Model(
            BranchRegisterResponseProto branchRegisterResponseProto) {
