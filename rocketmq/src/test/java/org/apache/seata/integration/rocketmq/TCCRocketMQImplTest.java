...
public class TCCRocketMQImplTest {
    @Mock private SeataMQProducer producer;

    @Mock private DefaultMQProducerImpl producerImpl;
    @Mock private BusinessActionContext businessActionContext;
    ...
    void testPrepare() throws MQClientException {
        ...
        try {
            ...
            mockedStatic
                    .when(BusinessActionContextUtil::getContext)
                    .thenReturn(businessActionContext);
    ...
    void testPrepareWithException() throws MQClientException {
        ...
        try {
            ...
            assertThrows(
                    MQClientException.class, () -> prepareTccRocketMQ.prepare(message, timeout));
