...
public class SeataMQProducer extends TransactionMQProducer {
    ...
    private static final List<GlobalStatus> COMMIT_STATUSES =
            Arrays.asList(
                    GlobalStatus.Committed, GlobalStatus.Committing, GlobalStatus.CommitRetrying);
                ...
                new TransactionListener() {
                    ...
                    public LocalTransactionState checkLocalTransaction(MessageExt msg) {
                        ...
                        if (StringUtils.isBlank(xid)) {
                            LOGGER.error(
                                    "msg has no xid, msgTransactionId: {}, msg will be rollback",
                        ...
                        GlobalStatus globalStatus =
                                DefaultResourceManager.get()
                                        .getGlobalStatus(
                                                SeataMQProducerFactory.ROCKET_BRANCH_TYPE, xid);
                        if (COMMIT_STATUSES.contains(globalStatus)) {
                            ...
                            LOGGER.error(
                                    "global transaction finished, msg will be rollback, xid: {}",
                                    xid);
                            return LocalTransactionState.ROLLBACK_MESSAGE;
                        }
                        return LocalTransactionState.UNKNOW;
    ...
    public SendResult doSendMessageInTransaction(
            final Message msg, long timeout, String xid, long branchId) throws MQClientException {
        ...
        MessageAccessor.putProperty(
                msg, MessageConst.PROPERTY_PRODUCER_GROUP, this.getProducerGroup());
