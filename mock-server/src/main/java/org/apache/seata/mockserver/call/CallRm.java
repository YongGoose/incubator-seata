...
public class CallRm {
     ...
     * @return
     */
    public static BranchStatus branchCommit(
            RemotingServer remotingServer, MockBranchSession branchSession) {
     ...
     * @return
     */
    public static BranchStatus branchRollback(
            RemotingServer remotingServer, MockBranchSession branchSession) {
     ...
     * @return
     */
    public static void deleteUndoLog(
            RemotingServer remotingServer, MockBranchSession branchSession) {
        ...
        try {
            Channel channel =
                    ChannelManager.getChannel(
                            branchSession.getResourceId(), branchSession.getClientId(), false);
