...
public class ExceptionUtils {
    ...
    public static EngineExecutionException createEngineExecutionException(
        ...
        return createEngineExecutionException(
                null, code, message, stateMachineInstance, stateInstance);
    }
        ...
        while (currentCause != null && dep > 0) {
            ...
            if (currentCause instanceof java.net.SocketTimeoutException) {
                ...
                return NetExceptionType.CONNECT_EXCEPTION;
                    ...
                    .getClass()
                    .getSimpleName()
                    .contains(CONNECT_TIME_OUT_EXCEPTION_CLASS_NAME)) {
                return NetExceptionType.CONNECT_TIMEOUT_EXCEPTION;
            } else if (currentCause
                    .getClass()
                    .getSimpleName()
                    .contains(READ_TIME_OUT_EXCEPTION_CLASS_NAME)) {
                return NetExceptionType.READ_TIMEOUT_EXCEPTION;
            } else if (currentCause
                    .getClass()
                    .getSimpleName()
                    .contains(CONNECT_EXCEPTION_CLASS_NAME)) {
                return NetExceptionType.CONNECT_EXCEPTION;
            } else {
