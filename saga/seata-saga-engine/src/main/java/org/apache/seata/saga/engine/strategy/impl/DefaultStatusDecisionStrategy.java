...
public class DefaultStatusDecisionStrategy implements StatusDecisionStrategy {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(DefaultStatusDecisionStrategy.class);
    ...
    public void decideOnEndState(
        ...
        if (ExecutionStatus.RU.equals(stateMachineInstance.getCompensationStatus())) {
            ...
            Object failEndStateFlag =
                    context.getVariable(DomainConstants.VAR_NAME_FAIL_END_STATE_FLAG);
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug(
                    "StateMachine Instance[id:{},name:{}] execute finish with status[{}],"
                            + " compensation status [{}].",
