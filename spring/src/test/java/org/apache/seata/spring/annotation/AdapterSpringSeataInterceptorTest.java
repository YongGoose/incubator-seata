...
class AdapterSpringSeataInterceptorTest {
    ...
    static void init() throws Throwable {
        ...
        ProxyInvocationHandler proxyInvocationHandler =
                DefaultInterfaceParser.get()
                        .parserInterfaceToProxy(normalTccAction, "proxyTccAction");
    ...
    void should_throw_raw_exception_when_call_prepareWithException() throws Throwable {
        MyMockMethodInvocation myMockMethodInvocation =
                new MyMockMethodInvocation(
                        NormalTccAction.class.getMethod(
                                "prepareWithException", BusinessActionContext.class),
                        () -> normalTccAction.prepareWithException(null));

        // when then
        Assertions.assertThrows(
                IllegalArgumentException.class,
                () -> adapterSpringSeataInterceptor.invoke(myMockMethodInvocation));
    }
    ...
    void should_success_when_call_prepare_with_ProxyInvocationHandler() throws Throwable {
        ...
        Assertions.assertTrue(
                (Boolean) adapterSpringSeataInterceptor.invoke(myMockMethodInvocation));
    }
