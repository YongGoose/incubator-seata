...
public class TableRecordsTest {
    ...
    public void testBuildRecordsNewFeild() throws SQLException {
        ...
        MockDriver mockDriverNewField =
                new MockDriver(
                        returnValueColumnLabelsNewField,
                        returnValueNewField,
                        columnMetasNewField,
                        indexMetas);
        ResultSet resultSet =
                mockDriverNewField.executeQuery(mockStatement, "select * from table_records_test");
        Assertions.assertThrows(
                TableMetaException.class, () -> TableRecords.buildRecords(tableMeta, resultSet));
    }
