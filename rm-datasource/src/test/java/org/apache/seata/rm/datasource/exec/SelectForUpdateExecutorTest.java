...
public class SelectForUpdateExecutorTest {
    ...
    public static void init() {
        ...
        MySQLSelectForUpdateRecognizer recognizer =
                new MySQLSelectForUpdateRecognizer(sql, asts.get(0));
    ...
    public void testDoExecute() throws Throwable {
        Assertions.assertThrows(
                RuntimeException.class, () -> selectForUpdateExecutor.doExecute((Object) null));
        ...
        connectionProxy =
                new MockLockConflictConnectionProxy(
        ...
        MySQLSelectForUpdateRecognizer recognizer =
                new MySQLSelectForUpdateRecognizer(sql, asts.get(0));
        selectForUpdateExecutor =
                new SelectForUpdateExecutor(statementProxy, (statement, args) -> null, recognizer);
