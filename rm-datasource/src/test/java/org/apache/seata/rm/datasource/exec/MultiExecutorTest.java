...
public class MultiExecutorTest {
    ...
    public void testBeforeImageAndAfterImages() throws SQLException {
        ...
        String sql =
                "update table_multi_executor_test set name = 'WILL' where id = 1;"
        ...
        Assertions.assertTrue(
                items.stream()
                        .allMatch(
                                t ->
                                        Objects.equals(t.getSqlType(), SQLType.UPDATE)
                                                && Objects.equals(
                                                        t.getTableName(),
                                                        "table_multi_executor_test")));
        ...
        // same table delete
        sql =
                "delete from table_multi_executor_test where id = 2;"
        ...
        // multi table update
        sql =
                "update table_multi_executor_test set name = 'WILL' where id = 1;update"
                        + " table_multi_executor_test2 set name = 'WILL' where id = 1;update"
                        + " table_multi_executor_test2 set name = 'WILL' where id = 3;";
        multi = SQLVisitorFactory.get(sql, JdbcConstants.MYSQL);
        executor =
                new MultiExecutor(
                        statementProxy,
        ...
        // multi table delete
        sql =
                "delete from table_multi_executor_test2 where id = 2;delete from"
                        + " table_multi_executor_test where id = 3;delete from"
                        + " table_multi_executor_test where id = 4;delete from"
                        + " table_multi_executor_test";
        multi = SQLVisitorFactory.get(sql, JdbcConstants.MYSQL);
        executor =
                new MultiExecutor(
        ...
        sql =
                "delete from table_multi_executor_test2 where id = 2;delete from"
                        + " table_multi_executor_test2 where id = 2 limit 1;";
        multi = SQLVisitorFactory.get(sql, JdbcConstants.MYSQL);
        executor =
                new MultiExecutor(
                        statementProxy,
        ...
        sql =
                "delete from table_multi_executor_test2 where id = 2;delete from"
                        + " table_multi_executor_test2 where id = 2 order by id desc limit 1;";
        multi = SQLVisitorFactory.get(sql, JdbcConstants.MYSQL);
        executor =
                new MultiExecutor(
                        statementProxy,
        ...
        sql =
                "update table_multi_executor_test set name = 'WILL' where id = 1;update"
                    + " table_multi_executor_test set name = 'WILL' where id = 1 order by id desc;";
        multi = SQLVisitorFactory.get(sql, JdbcConstants.MYSQL);
        executor =
                new MultiExecutor(
                        statementProxy,
