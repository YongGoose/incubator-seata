...
public class MariadbTableMetaCacheTest {
    ...
    public void getTableMetaTest_0() throws SQLException {
        ...
        TableMeta tableMeta =
                getTableMetaCache()
                        .getTableMeta(proxy.getPlainConnection(), "mt1", proxy.getResourceId());
        ...
        Assertions.assertThrows(
                ...
                () -> {
                    getTableMetaCache()
                            .getTableMeta(proxy.getPlainConnection(), "mt2", proxy.getResourceId());
                });
    ...
    public void refreshTest_0() throws SQLException {
        ...
        getTableMetaCache()
                .refresh(dataSourceProxy.getPlainConnection(), dataSourceProxy.getResourceId());
    }
