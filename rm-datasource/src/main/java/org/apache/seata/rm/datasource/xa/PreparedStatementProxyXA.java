...
public class PreparedStatementProxyXA extends StatementProxyXA implements PreparedStatement {
    ...
    public PreparedStatementProxyXA(
            AbstractConnectionProxyXA connectionProxyXA, PreparedStatement targetStatement) {
    ...
    public ResultSet executeQuery() throws SQLException {
        return ExecuteTemplateXA.execute(
                connectionProxyXA,
                (statement, args) -> statement.executeQuery(),
                getTargetStatement());
    }
    ...
    public int executeUpdate() throws SQLException {
        return ExecuteTemplateXA.execute(
                connectionProxyXA,
                (statement, args) -> statement.executeUpdate(),
                getTargetStatement());
    }
