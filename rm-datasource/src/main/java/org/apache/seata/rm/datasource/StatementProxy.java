...
public class StatementProxy<T extends Statement> extends AbstractStatementProxy<T> {
    ...
    public StatementProxy(
            AbstractConnectionProxy connectionWrapper, T targetStatement, String targetSQL)
            throws SQLException {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ...
        return ExecuteTemplate.execute(
                this, (statement, args) -> statement.executeQuery((String) args[0]), sql);
    }
    ...
    public int executeUpdate(String sql) throws SQLException {
        this.targetSQL = sql;
        return ExecuteTemplate.execute(
                this, (statement, args) -> statement.executeUpdate((String) args[0]), sql);
    }
    ...
    public boolean execute(String sql) throws SQLException {
        this.targetSQL = sql;
        return ExecuteTemplate.execute(
                this, (statement, args) -> statement.execute((String) args[0]), sql);
    }
