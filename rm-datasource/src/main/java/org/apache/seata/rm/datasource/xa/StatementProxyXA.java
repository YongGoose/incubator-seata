...
public class StatementProxyXA implements Statement {
    ...
    public StatementProxyXA(
            AbstractConnectionProxyXA connectionProxyXA, Statement targetStatement) {
    ...
    public boolean execute(String sql) throws SQLException {
        return ExecuteTemplateXA.execute(
                connectionProxyXA,
                (statement, args) -> statement.execute((String) args[0]),
                targetStatement,
                sql);
    }
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        return ExecuteTemplateXA.execute(
                connectionProxyXA,
                (statement, args) -> statement.executeQuery((String) args[0]),
                targetStatement,
                sql);
    }
