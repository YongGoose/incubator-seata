...
public class MySQLSelectForUpdateRecognizerForListenerTest {
    ...
    public void selectForUpdateRecognizerTest_2() {
        ...
        Assertions.assertEquals(
                "'id'",
                mySqlContext.getQueryWhereValColumnNames().get(0).getQueryWhereValColumnName());
    }
    ...
    public void selectForUpdateRecognizerTest_3() {
        ...
        String sql =
                "SELECT name,phone FROM t1 WHERE id = 1 and username = '11' and age = 'a' or hz ="
                        + " '1' or aa = 1 FOR UPDATE";
        ...
        Assertions.assertEquals(
                "username",
                mySqlContext.getQueryWhereColumnNames().get(1).getQueryWhereColumnName());
        Assertions.assertEquals(
                "'a'",
                mySqlContext.getQueryWhereValColumnNames().get(2).getQueryWhereValColumnName());
        Assertions.assertEquals(
                "id = 1 and username = '11' and age = 'a' or hz = '1' or aa = 1",
                mySqlContext.getWhereCondition());
    }
    ...
    public void selectForUpdateRecognizerTest_4() {
        ...
        Assertions.assertEquals(
                "101",
                mySqlContext.getQueryWhereValColumnNames().get(1).getQueryWhereValColumnName());
    ...
    public void selectForUpdateRecognizerTest_5() {
        ...
        String sql =
                "SELECT name1, name2 FROM t1 WHERE name = 1 and id between 2 and 3 or img = '11'"
                        + " FOR UPDATE";
        ...
        Assertions.assertEquals(
                ...
                mySqlContext.getQueryWhereValColumnNames().get(2).getQueryWhereValColumnName());
        Assertions.assertEquals(
                "name = 1 and id between 2 and 3 or img = '11'", mySqlContext.getWhereCondition());
    }
}
