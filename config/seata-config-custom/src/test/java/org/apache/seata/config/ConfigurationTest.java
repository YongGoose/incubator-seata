...
class ConfigurationTest {
    ...
    void test_getConfig_Methods() {
        ...
        assertThat(configuration.getShort(dataId + NULL_POSTFIX))
                .isEqualTo(AbstractConfiguration.DEFAULT_SHORT);
        ...
        assertThat(configuration.getInt(dataId + NULL_POSTFIX))
                .isEqualTo(AbstractConfiguration.DEFAULT_INT);
        ...
        assertThat(configuration.getLong(dataId + NULL_POSTFIX))
                .isEqualTo(AbstractConfiguration.DEFAULT_LONG);
        ...
        assertThat(configuration.getDuration(dataId + NULL_POSTFIX))
                .isEqualTo(AbstractConfiguration.DEFAULT_DURATION);
        ...
        assertThat(configuration.getBoolean(dataId + NULL_POSTFIX))
                .isEqualTo(AbstractConfiguration.DEFAULT_BOOLEAN);
