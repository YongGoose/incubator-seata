...
class FileConfigurationTest {
    ...
    void addConfigListener() throws InterruptedException {
        ...
        logger.info(
                System.currentTimeMillis() + ", dataId: {}, currenValue: {}",
                dataId,
                fileConfig.getBoolean(dataId));
        ...
        System.setProperty(dataId, String.valueOf(value));
        // sleep for a period of time to simulate waiting for a cache refresh.Actually, it doesn't
        // trigger.
        Thread.sleep(1000);
