    ...
    public void testSpringCloudAlibabaConfiguration() {
        ...
        SpringCloudAlibabaConfiguration springCloudAlibabaConfiguration =
                (SpringCloudAlibabaConfiguration)
                        applicationContext.getBean("springCloudAlibabaConfiguration");
        ...
        Assertions.assertEquals(
                "default_tx_group", springCloudAlibabaConfiguration.getTxServiceGroup());
        springCloudAlibabaConfiguration.setTxServiceGroup("default_tx_group_1");
        Assertions.assertEquals(
                "default_tx_group_1", springCloudAlibabaConfiguration.getTxServiceGroup());
