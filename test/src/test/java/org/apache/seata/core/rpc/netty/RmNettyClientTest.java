    ...
    public void testMergeMsg() throws Exception {
        ...
        new Thread(
                        () -> {
                            ...
                            nettyRemotingServer.setHandler(
        ...
        rmNettyRemotingClient
                ...
                .initReconnect(transactionServiceGroup, true);
            ...
            CompletableFuture.runAsync(
                    () -> {
                        ...
                        Assertions.assertEquals(
                                ResultCode.Failed, branchRegisterResponse.getResultCode());
                        Assertions.assertEquals(
                                "TransactionException[Could not found global transaction xid ="
                                        + " 127.0.0.1:8091:1249853, may be has finished.]",
