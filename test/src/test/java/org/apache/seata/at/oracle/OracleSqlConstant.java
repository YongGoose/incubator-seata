...
public class OracleSqlConstant {
    ...
    public static final String TEST_NUMBER_TYPE_INSERT_SQL =
            "INSERT INTO T_DATA_TYPE_NUMBER_TEST\n"
    ...
    public static final String TEST_NUMBER_TYPE_UPDATE_SQL =
            "UPDATE T_DATA_TYPE_NUMBER_TEST\n"
                + "set TINYINT_TEST = 312,MEDUIMINT_TEST = 654,INT_TEST = 55,BIGINT_TEST = 432,\n"
                + "    SMALLINT_TEST = 65,INTEGER_TEST = 32422,DECIMAL_TEST = 54654.22,NUMERIC_TEST"
                + " = 798.333,\n"
                + "    DEC_TEST = 888 WHERE id ="
                    + TEST_RECORD_ID;
    ...
    public static final String TEST_STRING_TYPE_INSERT_SQL =
            "INSERT INTO"
                + " T_DATA_TYPE_STRING_TEST(id,CHAR_TEST,NCHAR_TEST,VARCHAR_TEST,VARCHAR2_TEST,NVARCHAR2_TEST)\n"
                + "    VALUES (1,'1231测试','678123123测试','623234测试','90eq9wer9测试','我测试')";

    public static final String TEST_STRING_TYPE_UPDATE_SQL =
            "UPDATE T_DATA_TYPE_STRING_TEST\n"
                    + "    SET\n"
                    + "        CHAR_TEST = '33333',NCHAR_TEST = '55555',VARCHAR_TEST ="
                    + " '测试汇总',VARCHAR2_TEST = '测试varchar2',\n"
                    + "        NVARCHAR2_TEST = '最后一列' WHERE id = "
                    + TEST_RECORD_ID;
    ...
    public static final String TEST_DATE_TYPE_UPDATE_SQL =
            "UPDATE T_DATA_TYPE_DATE_TEST SET DATE_TEST = SYSDATE+2,TIMESTAMP_TEST ="
                    + " SYSDATE+2,TIMESTAMP_TZ = SYSDATE+2,TIMESTAMP_TZL = SYSDATE+2 where ID = "
                    + TEST_RECORD_ID;
    ...
    public static final String TEST_BINARY_TYPE_INSERT_SQL =
            "INSERT INTO T_DATA_TYPE_BINARY_TEST \n"
                    + "VALUES(1,\n"
    ...
    public static final String TEST_BINARY_TYPE_UPDATE_SQL =
            "UPDATE T_DATA_TYPE_BINARY_TEST\n"
                    + "SET BLOB_TEST = TO_BLOB('111111111000111111111111111'),\n"
                    + "CLOB_TEST = TO_CLOB('111111111111000111111111111111'),\n"
                    + "BFILE_TEST = BFILENAME('BFILEDIR',"
                    + " 'seata/src/test/java/io/seata/at/oracle/bfile.txt'),\n"
