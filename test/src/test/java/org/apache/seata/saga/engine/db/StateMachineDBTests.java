...
public class StateMachineDBTests extends AbstractServerTest {
    ...
    public static void initApplicationContext() throws InterruptedException {
        ...
        ApplicationContext applicationContext =
                new ClassPathXmlApplicationContext(
                        "classpath:saga/spring/statemachine_engine_db_test.xml");
        stateMachineEngine =
        ...
        SagaCostPrint.executeAndPrint(
                ...
                () -> {
                    ...
                    Assertions.assertEquals(
                            GlobalStatus.CommitRetrying, globalTransaction.getStatus());
                });
    }
    ...
    public void testStateMachineTransTimeout() throws Exception {
        ((DefaultStateMachineConfig) stateMachineEngine.getStateMachineConfig())
                .setTransOperationTimeout(1500);
        ...
        ((DefaultStateMachineConfig) stateMachineEngine.getStateMachineConfig())
                .setTransOperationTimeout(60000 * 30);
    }
    ...
    private void doTestStateMachineTransTimeout(Map<String, Object> paramMap, int i)
            throws Exception {
        String stateMachineName = "simpleCompensationStateMachine";
        ...
        SagaCostPrint.executeAndPrint(
                ...
                () -> {
                    ...
                    Assertions.assertTrue(
                            ExecutionStatus.UN.equals(inst.getStatus())
                                    || ExecutionStatus.SU.equals(inst.getStatus()));
                    Assertions.assertEquals(ExecutionStatus.SU, inst.getCompensationStatus());
                });
    }

    private void doTestStateMachineTransTimeoutAsync(Map<String, Object> paramMap, int i)
            throws Exception {
        String stateMachineName = "simpleCompensationStateMachine";
    ...
    private void doTestStateMachineCustomRecoverStrategyOnTimeout(
            Map<String, Object> paramMap, int i) throws Exception {
        ...
        SagaCostPrint.executeAndPrint(
                ...
                () -> {
                    ...
                    while (!(ExecutionStatus.SU.equals(inst.getStatus())
                        ...
                        System.out.println("====== GlobalStatus: " + globalTransaction.getStatus());
                        System.out.println(
                                "====== StateMachineInstanceStatus: " + inst.getStatus());
                        Thread.sleep(2500);
                        inst =
                                stateMachineEngine
                                        .getStateMachineConfig()
    ...
    private void doTestStateMachineCustomRecoverStrategyOnTimeoutAsync(
            Map<String, Object> paramMap, int i) throws Exception {
        String stateMachineName = "simpleStateMachineWithRecoverStrategy";
