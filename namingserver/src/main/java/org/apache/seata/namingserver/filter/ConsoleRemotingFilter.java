            ...
            if (urlPattern
                ...
                if (StringUtils.isNotBlank(namespace)
                    ...
                    if (StringUtils.isNotBlank(vgroup)) {
                        list =
                                namingManager.getInstancesByVgroupAndNamespace(
                                        namespace,
                                        vgroup,
                                        StringUtils.equalsIgnoreCase(
                                                request.getMethod(), HttpMethod.GET.name()));
                    ...
                    if (CollectionUtils.isNotEmpty(list)) {
                        ...
                        if (controlEndpoint != null) {
                            ...
                            HttpEntity<byte[]> httpEntity =
                                    new HttpEntity<>(request.getCachedBody(), headers);

                            // Forward the request
                            AsyncContext asyncContext = servletRequest.startAsync();
                            asyncContext.setTimeout(5000L);
                            ListenableFuture<ResponseEntity<byte[]>> responseEntityFuture =
                            ...
                            responseEntityFuture.addCallback(
                                    new ListenableFutureCallback<ResponseEntity<byte[]>>() {
                                        @Override
