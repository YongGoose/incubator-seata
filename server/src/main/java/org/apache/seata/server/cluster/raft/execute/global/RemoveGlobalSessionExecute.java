...
public class RemoveGlobalSessionExecute extends AbstractRaftMsgExecute {
    ...
    public Boolean execute(RaftBaseMsg syncMsg) throws Throwable {
        ...
        // when the global transaction needs to be deleted, it does not affect any consistency
        // issues, and can be
        ...
        Optional.ofNullable(
                        raftSessionManager.findGlobalSession(
                        ...
                        globalSession -> {
                            try {
                                ...
                                EXECUTOR.execute(
                                        () -> {
                                            try {
                                                raftSessionManager.removeGlobalSession(
                                                        globalSession);
