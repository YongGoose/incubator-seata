...
public class GlobalSessionRedisServiceImpl extends AbstractGlobalService
        implements GlobalSessionService {

    private static final Logger LOGGER =
            LoggerFactory.getLogger(GlobalSessionRedisServiceImpl.class);
    ...
    public PageResult<GlobalSessionVO> query(GlobalSessionParam param) {
        ...
        if (param.getTimeStart() != null || param.getTimeEnd() != null) {
            ...
            return PageResult.failure(
                    ParameterRequired.getErrCode(), "not supported according to time range query");
        }
        ...
        if (isBlank(param.getXid()) && param.getStatus() == null) {
            ...
            globalSessions =
                    instance.findGlobalSessionByPage(
            ...
            if (param.getStatus() != null && GlobalStatus.get(param.getStatus()) != null) {
                if (CollectionUtils.isNotEmpty(globalSessions)) {
                    ...
                    total =
                            instance.countByGlobalSessions(
                                    new GlobalStatus[] {GlobalStatus.get(param.getStatus())});
        ...
        return PageResult.success(
                result, total.intValue(), param.getPageNum(), param.getPageSize());
    }
}
