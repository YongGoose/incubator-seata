...
public class DbcpDataSourceProvider extends AbstractDataSourceProvider {
    ...
    public DataSource doGenerate() {
        ...
        ds.setConnectionProperties(
                "useUnicode=yes;characterEncoding=utf8;socketTimeout=5000;connectTimeout=500");
        ...
        long minEvictableIdleTimeMillis =
                CONFIG.getLong(
                        ConfigurationKeys.STORE_DB_DBCP_MIN_EVICTABLE_TIME_MILLIS,
        ...
        boolean testWhileIdle =
                CONFIG.getBoolean(
                        ConfigurationKeys.STORE_DB_DBCP_TEST_WHILE_IDLE,
                        DEFAULT_DB_DBCP_TEST_WHILE_IDLE);
        ds.setTestWhileIdle(testWhileIdle);
        boolean testOnBorrow =
                CONFIG.getBoolean(
                        ConfigurationKeys.STORE_DB_DBCP_TEST_ON_BORROW,
                        DEFAULT_DB_DBCP_TEST_ON_BORROW);
