...
public abstract class AbstractRaftMsgExecute implements RaftMsgExecute<Boolean> {
    ...
    protected RaftLockManager raftLockManager =
            (RaftLockManager) LockerManagerFactory.getLockManager();

    protected VGroupMappingStoreManager raftVGroupMappingStoreManager =
