...
public class DruidDataSourceProvider extends AbstractDataSourceProvider {
    ...
    public DataSource doGenerate() {
        ...
        long minEvictableIdleTimeMillis =
                CONFIG.getLong(
                        ConfigurationKeys.STORE_DB_DRUID_MIN_EVICTABLE_TIME_MILLIS,
        ...
        boolean testWhileIdle =
                CONFIG.getBoolean(
                        ConfigurationKeys.STORE_DB_DRUID_TEST_WHILE_IDLE,
                        DEFAULT_DB_DRUID_TEST_WHILE_IDLE);
        ds.setTestWhileIdle(testWhileIdle);
        boolean testOnBorrow =
                CONFIG.getBoolean(
                        ConfigurationKeys.STORE_DB_DRUID_TEST_ON_BORROW,
                        DEFAULT_DB_DRUID_TEST_ON_BORROW);
        ds.setTestOnBorrow(testOnBorrow);
        boolean keepAlive =
                CONFIG.getBoolean(
                        ConfigurationKeys.STORE_DB_DRUID_KEEP_ALIVE, DEFAULT_DB_DRUID_KEEP_ALIVE);
