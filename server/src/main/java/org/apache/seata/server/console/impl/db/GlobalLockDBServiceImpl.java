...
public class GlobalLockDBServiceImpl extends AbstractLockService implements GlobalLockService {
    ...
    public PageResult<GlobalLockVO> query(GlobalLockParam param) {
        ...
        String sourceSql =
                LockStoreSqlFactory.getLogStoreSql(dbType).getAllLockSql(lockTable, whereCondition);
        String queryLockSql =
    ...
    public SingleResult<Void> deleteLock(GlobalLockParam param) {
        ...
        String deleteLockSql =
                LockStoreSqlFactory.getLogStoreSql(dbType).getDeleteLockSql(lockTable);
