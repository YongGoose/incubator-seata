...
public class SessionConverterTest {
    ...
    public void testConvertGlobalSessionNotNull() {
        ...
        Assertions.assertEquals(
                globalTransactionDO.getTransactionId(), globalSession.getTransactionId());
        Assertions.assertEquals(
                globalTransactionDO.getStatus(), globalSession.getStatus().getCode());
        Assertions.assertEquals(
                globalTransactionDO.getApplicationId(), globalSession.getApplicationId());
        Assertions.assertEquals(
                globalTransactionDO.getTransactionServiceGroup(),
                globalSession.getTransactionServiceGroup());
        Assertions.assertEquals(
                globalTransactionDO.getTransactionName(), globalSession.getTransactionName());
        ...
        Assertions.assertEquals(
                globalTransactionDO.getApplicationData(), globalSession.getApplicationData());
    }
    ...
    public void testConvertBranchSessionNotNull() {
        ...
        Assertions.assertEquals(
                branchTransactionDO.getTransactionId(), branchSession.getTransactionId());
        Assertions.assertEquals(branchTransactionDO.getBranchId(), branchSession.getBranchId());
        Assertions.assertEquals(
                branchTransactionDO.getResourceGroupId(), branchSession.getResourceGroupId());
        Assertions.assertEquals(branchTransactionDO.getResourceId(), branchSession.getResourceId());
        Assertions.assertEquals(
                branchTransactionDO.getBranchType(), branchSession.getBranchType().name());
        Assertions.assertEquals(
        ...
        Assertions.assertEquals(
                branchTransactionDO.getApplicationData(), branchSession.getApplicationData());
    }
    ...
    public void testConvertGlobalTransactionDONotNull() {
        ...
        GlobalSession globalSession =
                new GlobalSession("application1", "fsp_tx", "createOrder", 60);
        ...
        Assertions.assertEquals(
                globalSession.getTransactionId(), globalTransactionDO.getTransactionId());
        Assertions.assertEquals(
                globalSession.getStatus().getCode(), globalTransactionDO.getStatus());
        Assertions.assertEquals(
                globalSession.getTransactionName(), globalTransactionDO.getTransactionName());
        Assertions.assertEquals(
                globalSession.getApplicationId(), globalTransactionDO.getApplicationId());
        Assertions.assertEquals(
                globalSession.getTransactionServiceGroup(),
                globalTransactionDO.getTransactionServiceGroup());
        Assertions.assertEquals(
        ...
        Assertions.assertEquals(
                globalSession.getApplicationData(), globalTransactionDO.getApplicationData());
    }
    ...
    public void testConvertBranchTransactionDONotNull() {
        ...
        Assertions.assertEquals(
                branchSession.getTransactionId(), branchTransactionDO.getTransactionId());
        Assertions.assertEquals(branchSession.getBranchId(), branchTransactionDO.getBranchId());
        Assertions.assertEquals(
                branchSession.getBranchType().name(), branchTransactionDO.getBranchType());
        Assertions.assertEquals(
                branchSession.getResourceGroupId(), branchTransactionDO.getResourceGroupId());
        Assertions.assertEquals(branchSession.getClientId(), branchTransactionDO.getClientId());
        Assertions.assertEquals(
                branchSession.getStatus().getCode(), branchTransactionDO.getStatus());
        Assertions.assertEquals(
                branchSession.getApplicationData(), branchTransactionDO.getApplicationData());
    }
