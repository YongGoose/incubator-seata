...
public class RaftSyncMessageSerializerTest {
    ...
    public void testSerializerTest() throws Exception {
        ...
        RaftGlobalSessionSyncMsg raftSessionSyncMsg2 =
                (RaftGlobalSessionSyncMsg) raftSyncMessage2.getBody();
        Assertions.assertTrue(
                raftSessionSyncMsg2.getGlobalSession().getXid().equals(session.getXid()));
        Assertions.assertTrue(
                raftSessionSyncMsg.getMsgType().equals(raftSessionSyncMsg2.getMsgType()));
    }
}
