...
public class ResourceBundleUtil {
    ...
    private static final ResourceBundleUtil INSTANCE =
            new ResourceBundleUtil("error/ErrorCode", LOCALE);
    ...
    protected String parseStringValue(String strVal, Set<String> visitedPlaceholders) {
        ...
        while (startIndex != -1) {
            ...
            if (endIndex != -1) {
                String placeholder =
                        buf.substring(startIndex + DEFAULT_PLACEHOLDER_PREFIX.length(), endIndex);
                ...
                try {
                    ...
                    if (propVal != null) {
                        ...
                        startIndex =
                                buf.indexOf(
                                        DEFAULT_PLACEHOLDER_PREFIX, startIndex + propVal.length());
                    } else {
                        throw new SeataRuntimeException(
                                ErrorCode.ERR_CONFIG,
