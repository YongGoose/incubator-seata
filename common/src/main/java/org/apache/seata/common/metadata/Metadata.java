...
public class Metadata {
    ...
    private final Map<String /*vgroup*/, Map<String /*raft-group*/, Node>> leaders =
    ...
    public Node getLeader(String clusterName) {
        Map<String /*raft-group*/, Node> map =
                leaders.computeIfAbsent(clusterName, k -> new ConcurrentHashMap<>());
