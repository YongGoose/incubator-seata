...
public class EurekaRegistryServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        setStaticField(
                EurekaRegistryServiceImpl.class, "applicationInfoManager", mockAppInfoManager);
    }
    ...
    void testUnsubscribe() throws Exception {
        ...
        Assertions.assertFalse(
                listenerMap
                        .getOrDefault(testCluster, Collections.emptyList())
                        .contains(mockEventListener));
    ...
    public void testLookup() throws Exception {
        ...
        try (MockedStatic<ConfigurationFactory> mockedFactory =
            ...
            when(mockApplication.getInstances())
                    .thenReturn(Collections.singletonList(mockInstanceInfo));
    ...
    public void testClose() throws Exception {
        ...
        Assertions.assertNull(
                getStaticField(EurekaRegistryServiceImpl.class, "applicationInfoManager"));
    }
    ...
    @SuppressWarnings("unchecked")
    private static ConcurrentMap<String, List<EurekaEventListener>> getStaticListenerMap()
            throws Exception {
