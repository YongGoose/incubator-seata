...
class RaftRegistryServiceImplTest {
    ...
    public void testLoginFailed() throws IOException, NoSuchMethodException {
        ...
        try (MockedStatic<HttpClientUtil> mockedStatic = Mockito.mockStatic(HttpClientUtil.class)) {
            ...
            when(HttpClientUtil.doPost(
                            any(String.class), any(Map.class), any(Map.class), any(int.class)))
            ...
            assertThrows(
                    Exception.class,
                    () ->
                            refreshTokenMethod.invoke(
                                    RaftRegistryServiceImpl.getInstance(), "127.0.0.1:8092"));
        }
    }
    ...
    public void testSelectEndpoint()
        ...
        for (Node node : nodes) {
            ...
            ;
            String transactionEndpointStr =
                    (String) selectTransactionEndpointStrMethod.invoke(null, node);
            ;
