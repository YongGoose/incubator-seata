...
class HttpDispatchHandlerTest {
        ...
        try (MockedStatic<ControllerManager> mocked = Mockito.mockStatic(ControllerManager.class)) {
            ...
            HttpRequest request =
                    new DefaultFullHttpRequest(
                            HttpVersion.HTTP_1_1, HttpMethod.GET, "/test?param=testValue");
    ...
    void testRequestToNonexistentPath() {
        try (MockedStatic<ControllerManager> mocked = Mockito.mockStatic(ControllerManager.class)) {
            ...
            HttpRequest request =
                    new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.GET, "/notfound");
    ...
    void testHttpHeadMethod() {
        try (MockedStatic<ControllerManager> mocked = Mockito.mockStatic(ControllerManager.class)) {
            ...
            HttpRequest request =
                    new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.HEAD, "/head");
