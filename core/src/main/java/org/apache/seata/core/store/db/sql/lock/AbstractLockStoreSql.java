...
public class AbstractLockStoreSql implements LockStoreSql {
    ...
    protected static final String ALL_COLUMNS =
            ServerTableColumnsName.LOCK_TABLE_XID
                    ...
                    + ", "
                    + ServerTableColumnsName.LOCK_TABLE_RESOURCE_ID
                    + ", "
                    ...
                    + ", "
                    + ServerTableColumnsName.LOCK_TABLE_GMT_CREATE
                    + ", "
     ...
     */
    private static final String BATCH_DELETE_LOCK_SQL =
            "delete from "
                    + LOCK_TABLE_PLACE_HOLD
                    + " where "
                    + ServerTableColumnsName.LOCK_TABLE_XID
     ...
     */
    private static final String QUERY_LOCK_SQL =
            "select "
                    + ALL_COLUMNS
                    + " from "
                    + LOCK_TABLE_PLACE_HOLD
     ...
     */
    private static final String CHECK_LOCK_SQL =
            "select "
                    + ALL_COLUMNS
                    + " from "
                    + LOCK_TABLE_PLACE_HOLD
     ...
     */
    private static final String QUERY_ALL_LOCK =
            "select "
                    + ALL_COLUMNS
                    + " from "
                    + LOCK_TABLE_PLACE_HOLD
    ...
    public String getInsertLockSQL(String lockTable) {
        throw new NotSupportYetException(
                "unknown dbType:" + CONFIG.getConfig(ConfigurationKeys.STORE_DB_TYPE));
    }
