...
public class PostgresqlLogStoreSqls extends AbstractLogStoreSqls {
     ...
     */
    public static final String INSERT_GLOBAL_TRANSACTION_POSTGRESQL =
            "insert into "
     ...
     */
    public static final String UPDATE_GLOBAL_TRANSACTION_STATUS_POSTGRESQL =
            "update "
                    + GLOBAL_TABLE_PLACEHOLD
                    + "   set "
     ...
     */
    public static final String QUERY_GLOBAL_TRANSACTION_FOR_RECOVERY_POSTGRESQL =
            "select "
                    + ALL_GLOBAL_COLUMNS
                    + "  from "
                    + GLOBAL_TABLE_PLACEHOLD
     ...
     */
    public static final String INSERT_BRANCH_TRANSACTION_POSTGRESQL =
            "insert into "
     ...
     */
    public static final String UPDATE_BRANCH_TRANSACTION_STATUS_POSTGRESQL =
            "update "
                    + BRANCH_TABLE_PLACEHOLD
                    + "   set "
     ...
     */
    public static final String UPDATE_BRANCH_STATUS_APPLICATION_DATA_POSTGRESQL =
            "update "
                    + BRANCH_TABLE_PLACEHOLD
                    + "   set "
                    + ServerTableColumnsName.BRANCH_TABLE_STATUS
    ...
    public String getUpdateGlobalTransactionStatusSQL(String globalTable) {
        return UPDATE_GLOBAL_TRANSACTION_STATUS_POSTGRESQL.replace(
                GLOBAL_TABLE_PLACEHOLD, globalTable);
    }

    @Override
    public String getUpdateGlobalTransactionStatusByStatusSQL(String globalTable) {
        return UPDATE_GLOBAL_TRANSACTION_STATUS_BY_STATUS_POSTGRESQL.replace(
                GLOBAL_TABLE_PLACEHOLD, globalTable);
    }
    ...
    public String getQueryGlobalTransactionForRecoverySQL(String globalTable) {
        return QUERY_GLOBAL_TRANSACTION_FOR_RECOVERY_POSTGRESQL.replace(
                GLOBAL_TABLE_PLACEHOLD, globalTable);
    }
    ...
    public String getUpdateBranchTransactionStatusSQL(String branchTable) {
        return UPDATE_BRANCH_TRANSACTION_STATUS_POSTGRESQL.replace(
                BRANCH_TABLE_PLACEHOLD, branchTable);
    }

    @Override
    public String getUpdateBranchTransactionStatusAppDataSQL(String branchTable) {
        return UPDATE_BRANCH_STATUS_APPLICATION_DATA_POSTGRESQL.replace(
                BRANCH_TABLE_PLACEHOLD, branchTable);
    }
}
